...
with open(r"c:\Users\Admin\Desktop\Parking Building Management System\parking-system\FE\src\components\layout\Navbar.tsx", "r", encoding="utf-8") as f:
    content = f.read()

# Add state
if "const [isNotifOpen, setIsNotifOpen] = useState(false);" not in content:
...
with open(r"c:\Users\Admin\Desktop\Parking Building Management System\parking-system\FE\src\components\layout\Navbar.tsx", "w", encoding="utf-8") as f:
    f.write(content)
print("Updated User Navbar!")
