                                ...
                                <div className="space-y-6">
                                   ...
                                   <div className="grid grid-cols-2 gap-6">
                                      ...
                                      <div>
                                         ...
                                         <select className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-900 outline-none" disabled>
                                ...
                                <div className="flex items-center gap-8">
                                   ...
                                   <div className="space-y-4 flex-1">
                                      <p className="text-xs text-slate-500 font-medium leading-relaxed">
                                        {'Logo của bạn sẽ xuất hiện trên bảng quản trị, ứng dụng người dùng và hóa đơn in ra.'}
                                      </p>
                                    ...
                                    {prices.map((p: any, i: number) => (
                                      <div key={i} className="p-6 bg-slate-50/50 rounded-[1.5rem] border border-slate-200/80 hover:bg-white hover:border-blue-500/50 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300 group cursor-pointer relative overflow-hidden">
                                         ...
                                         <p className="text-[11px] font-black text-slate-400 uppercase tracking-widest mb-4 relative z-10">
                                           {p.type === 'Xe máy' ? ('Xe máy')
                                            : p.type === 'Ô tô 4-7 chỗ' ? ('Ô tô 4-7 chỗ')
                                            : p.type === 'SUV / Bán tải' ? ('SUV / Bán tải')
                                            : p.type}
                                         </p>
                                         ...
                                         <p className="text-[11px] font-bold text-slate-400 mt-2 relative z-10">
                                           {p.sub === 'VNĐ / Lượt' ? ('VNĐ / Lượt')
                                            : p.sub === 'VNĐ / Giờ' ? ('VNĐ / Giờ')
                                            : p.sub}
                                         </p>
                                      </div>
                                    ))}
            ...
            >
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">
                  {'Thông tin đã được cập nhật real-time'}
                </p>
              </div>
            </motion.div>
          )}
