...
const AdminMonitoring = () => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      parkingService.getParkingSessions().then(res => {
         if (res.data) {
      ...
      parkingService.getParkingLots().then(res => {
                     ...
                     <div className="w-full h-full max-w-5xl max-h-[600px] bg-white rounded-[2rem] shadow-xl shadow-slate-200/40 border border-slate-200/80 relative overflow-hidden">
                        <svg viewBox="0 0 1000 600" className="w-full h-full">
                          ...
                          <g transform="translate(500, 250)">
                            ...
                            <text x="0" y="0" textAnchor="middle" fontSize="7" fontWeight="bold" fill="#94a3b8">{'LIẤT & THANG'}</text>
                              ...
                              <div className="flex gap-3">
                                ...
                                <button 
                                  onClick={async () => {
                                    ...
                                    if (!sessionId) return showToast("Lỗi: Không tìm thấy ID phiên.", 'error');
                                    try {
                                      await parkingService.changeSlot(sessionId,  { newSlot: newSlotInput.trim().toUpperCase() });
