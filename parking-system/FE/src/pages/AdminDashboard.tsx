    ...
    <div className="bg-[#f8f9fb] text-[#191c1e] min-h-screen flex font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      <aside className="hidden md:flex flex-col h-screen py-8 sticky left-0 top-0 bg-white border-r border-slate-200 w-[280px] z-50 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
        ...
        <div className="px-4 mt-auto space-y-6">
          <div className="bg-blue-50 rounded-2xl p-5 border border-blue-100">
            <p className="text-xs font-bold text-blue-900 mb-1">Upgrade Plan</p>
            <p className="text-[10px] text-blue-600 font-medium mb-4 leading-relaxed">Mở khóa phân tích nâng cao và dự báo AI.</p>
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-[#f8f9fb]">
        ...
        <header className="flex justify-between items-center h-20 px-10 w-full sticky top-0 z-40 bg-white/80 backdrop-blur-xl border-b border-slate-200">
          <div className="flex items-center gap-4 bg-slate-100/80 px-4 py-2.5 rounded-2xl border border-slate-200 focus-within:ring-2 focus-within:ring-blue-600/20 transition-all">
            <Search className="text-slate-400 w-4.5 h-4.5" />
            <input className="bg-transparent border-none focus:ring-0 text-sm text-slate-900 w-64 p-0 placeholder:text-slate-400" placeholder="Tìm kiếm dữ liệu..." type="text"/>
          </div>
