      ...
      <div className="p-8 md:p-10 space-y-8 min-h-screen">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div className="flex flex-col gap-1.5">
            <h1 className="text-2xl font-black text-slate-900 tracking-tight">Quản lý Chi nhánh & Tòa nhà</h1>
            <p className="text-sm font-semibold text-slate-500">Giám sát sức chứa, hiệu suất và doanh thu của tất cả khu vực.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-white p-7 rounded-[24px] border border-slate-100 shadow-[0_4px_24px_rgba(0,0,0,0.02)] relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="flex justify-between items-start mb-6">
              ...
              <span className="text-[10px] font-black px-3 py-1 rounded-full bg-blue-100/50 text-blue-700 relative z-10">TỔNG SỐ</span>
            </div>
            <p className="text-[11px] font-bold text-slate-400 uppercase tracking-[0.15em] mb-2 relative z-10">CHI NHÁNH HOẠT ĐỘNG</p>
          ...
          <div className="bg-white p-7 rounded-[24px] border border-slate-100 shadow-[0_4px_24px_rgba(0,0,0,0.02)] relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="flex justify-between items-start mb-6">
              ...
              <span className="text-[10px] font-black px-3 py-1 rounded-full bg-amber-100/50 text-amber-700 relative z-10">THỰC TẾ</span>
            </div>
            <p className="text-[11px] font-bold text-slate-400 uppercase tracking-[0.15em] mb-2 relative z-10">SỨC CHỨA / ĐANG ĐỖ</p>
          ...
          <div className="bg-white p-7 rounded-[24px] border border-slate-100 shadow-[0_4px_24px_rgba(0,0,0,0.02)] relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="flex justify-between items-start mb-6">
              ...
              <span className="text-[10px] font-black px-3 py-1 rounded-full bg-emerald-100/50 text-emerald-700 relative z-10">LŨY KẾ</span>
            </div>
            <p className="text-[11px] font-bold text-slate-400 uppercase tracking-[0.15em] mb-2 relative z-10">TỔNG LƯỢT GIAO DỊCH</p>
          ...
          <div className="bg-white p-7 rounded-[24px] border border-slate-100 shadow-[0_4px_24px_rgba(0,0,0,0.02)] relative overflow-hidden group hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="flex justify-between items-start mb-6">
              ...
              <span className="text-[10px] font-black px-3 py-1 rounded-full bg-indigo-100/50 text-indigo-700 relative z-10">THỰC TẾ</span>
            </div>
            <p className="text-[11px] font-bold text-slate-400 uppercase tracking-[0.15em] mb-2 relative z-10">TỔNG DOANH THU</p>
        ...
        <div className="bg-white p-8 md:p-10 rounded-[24px] border border-slate-200/80 shadow-[0_4px_24px_rgba(0,0,0,0.02)] relative z-10">
          <div className="flex justify-between items-center mb-10">
            <h3 className="text-lg font-black text-slate-900 tracking-tight">Biểu đồ Doanh thu năm {new Date().getFullYear()}</h3>
            <div className="flex items-center gap-2">
               <div className="w-2.5 h-2.5 bg-blue-600 rounded-full"></div>
               <span className="text-[10px] font-black text-slate-400 uppercase">Doanh thu (VNĐ)</span>
            </div>
          </div>
               ...
               <div key={branch.id} className="bg-white rounded-[28px] border border-slate-200/60 shadow-[0_8px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_24px_50px_rgba(0,0,0,0.08)] hover:-translate-y-1.5 transition-all duration-400 overflow-hidden flex flex-col group cursor-pointer relative">
                 ...
                 <div className="p-7 border-b border-slate-100/60 relative z-10">
                   ...
                   <div className="mb-2">
                     <div className="flex justify-between items-end mb-2">
                        <div>
                          <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-0.5">Sức chứa</span>
                 ...
                 <div className="p-7 bg-white/50 backdrop-blur-sm flex-1 grid grid-cols-2 gap-4 border-b border-slate-100/60 relative z-10">
                   <div className="bg-slate-50/80 rounded-2xl p-4 border border-slate-200/50 group-hover:bg-white transition-colors">
                      <div className="flex items-center gap-2 text-slate-400 mb-1.5">
                         ...
                         <span className="text-[10px] font-black uppercase tracking-wider">Số tầng</span>
                      </div>
                   ...
                   <div className="bg-slate-50/80 rounded-2xl p-4 border border-slate-200/50 group-hover:bg-white transition-colors">
                      <div className="flex items-center gap-2 text-slate-400 mb-1.5">
                         ...
                         <span className="text-[10px] font-black uppercase tracking-wider">Block/Khu</span>
                      </div>
                      <div className="text-lg font-black text-slate-800 line-clamp-1">{branch.block || 'Chưa chia'}</div>
                   </div>
                   <div className="bg-slate-50/80 rounded-2xl p-4 border border-slate-200/50 group-hover:bg-white transition-colors">
                      <span className="block text-[10px] font-black text-slate-400 uppercase tracking-wider mb-1.5">Giao dịch lũy kế</span>
                   ...
                   <div className="bg-slate-50/80 rounded-2xl p-4 border border-slate-200/50 group-hover:bg-blue-50 transition-colors">
                      <span className="block text-[10px] font-black text-slate-400 uppercase tracking-wider mb-1.5">Doanh thu</span>
                 ...
                 <div className="px-7 py-5 bg-white flex justify-between items-center relative z-10">
                    <div className="flex items-center gap-2.5">
                      ...
                      <span className="text-sm font-bold text-slate-700">{isFull ? 'Bãi đã đầy' : 'Đang hoạt động'}</span>
                    </div>
