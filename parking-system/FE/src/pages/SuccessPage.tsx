...
import { useSuccessSession } from '../hooks/useSuccessSession';

const SuccessPage = () => {
  const {
    mode, qrCode, status, licensePlate, qrDataUrl,
    selectedSlot, parkingInfo, displayFloor, resDate, resTime,
  } = useSuccessSession();
