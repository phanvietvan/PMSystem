...
const RegisterPage = () => {
  const {
    step, setStep, loading, firstName, setFirstName, lastName, setLastName,
    email, setEmail, password, setPassword, confirmPassword, setConfirmPassword,
    otp, setOtp, error, timer, canResend, handleResendOtp, loginGoogle, handleNext,
    getPasswordStrength,
  } = useRegister();
                    ...
                    <div className="space-y-6 animate-fade-in-up">
                      ...
                      <div className="flex items-start gap-3 px-1">
                        ...
                        <label htmlFor="terms" className="text-xs text-slate-500 leading-relaxed">
                          {'Tôi đồng ý với '}
                          <Link to="/terms" className="text-blue-600 font-bold">{'Điều khoản sử dụng'}</Link>
                          {' và '}
                          <Link to="/privacy" className="text-blue-600 font-bold">{'Chính sách bảo mật'}</Link>.
                        </label>
                      </div>
                      <button
                    ...
                    <div className="space-y-6 animate-fade-in-up">
                      <div className="text-center p-4 rounded-2xl bg-indigo-50/40 border border-indigo-100/50">
                        <p className="text-xs text-slate-500 font-medium">
                          {'Mã OTP đăng ký đã được gửi đến email của bạn thành công.'}
                        </p>
                      </div>
                      <div className="space-y-2">
