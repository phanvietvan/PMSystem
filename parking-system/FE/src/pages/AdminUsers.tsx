            ...
            <div className="p-10 space-y-10">
               <div>
                  ...
                  <p className="text-sm text-slate-500 font-medium">
                    {'Phân quyền và quản lý tài khoản nhân viên toàn hệ thống.'}
                  </p>
                  {error && !editing && (
               ...
               <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
                  ...
                  <div className="px-8 py-6 bg-slate-50/50 border-t border-slate-100 flex justify-between items-center">
                     <span className="text-xs font-bold text-slate-400">
                       {'Hiển thị'} {filtered.length} / {users.length} {'nhân sự'}
                     </span>
                  ...
                  <div className="p-8 space-y-6 max-h-[70vh] overflow-y-auto">
                    ...
                    <div className="bg-slate-50 border border-slate-100 p-4.5 rounded-2xl space-y-3">
                      <span className="text-[10px] font-black text-slate-400 uppercase tracking-wider block">
                        {'Danh sách phương tiện'} ({parsedVehicles.length})
                      </span>
                    ...
                    <div className="space-y-3.5 pt-2">
                      ...
                      <div className="flex justify-between items-center py-2 border-b border-slate-100">
                        ...
                        <span className="text-xs font-extrabold text-slate-700">
                          {viewingUser.createdAt ? new Date(viewingUser.createdAt).toLocaleDateString('vi-VN') : 'Chưa có'}
                        </span>
                      </div>
                    </div>
