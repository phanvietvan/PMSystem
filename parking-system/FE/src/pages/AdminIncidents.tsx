  ...
  return (
    <AdminLayout>
          <div className="p-10 space-y-10">
            <div>
              <h2 className="text-3xl font-black text-slate-900 tracking-tight mb-2">{'Quản lý sự cố'}</h2>
              <p className="text-sm text-slate-500 font-medium">{'Xem và xử lý các sự cố được báo cáo từ người dùng'}</p>
            </div>
